...
# Given Vector2i coordinates, calculates and returns the corresponding integer index. You can use
...
#	You can use Grid.as_index() to pre-allocate and index a one-dimensional array representing a 2D grid. 
# Depending on your game’s needs, you can store your game board’s state using an array, including all obstacles.
# Iterating through a 1D array in Godot is faster than a 2D array
